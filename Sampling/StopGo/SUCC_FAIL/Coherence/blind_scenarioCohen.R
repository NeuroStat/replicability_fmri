...
# Provide working directory: same sample sizes as other contrast
wd <- "/Volumes/2_TB_WD_Elements_10B8_Han/PhD/IMAGENDATA/Data/FreddieFreeloader/SampleSizes/StopGo/Coherence/"
