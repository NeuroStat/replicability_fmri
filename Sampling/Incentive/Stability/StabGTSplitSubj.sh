...
scp $data/33/EPI_short_MID/con_0032_feedback_hit_largewin_-_smallwin.nii.gz .
...
$FSLDIR/bin/fslcpgeom con_0032_feedback_hit_largewin_-_smallwin.nii clusteroutput.nii.gz
# Also for tstat1.nii, because we use it later on in transformations
		...
		rm con_0032_feedback_hit_largewin_-_smallwin.nii
		cd ..
rm con_0032_feedback_hit_largewin_-_smallwin.nii
