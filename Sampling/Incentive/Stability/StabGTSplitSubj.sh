...
scp $data/33/EPI_short_MID/con_0006_feedback_hit_nowin.nii.gz .
...
$FSLDIR/bin/fslcpgeom con_0006_feedback_hit_nowin.nii clusteroutput.nii.gz
# Also for tstat1.nii, because we use it later on in transformations
		...
		rm con_0006_feedback_hit_nowin.nii
		cd ..
rm con_0006_feedback_hit_nowin.nii
