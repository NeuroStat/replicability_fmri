####################
#### TITLE:     Calculate within samplesize stability: 10-100 controlling for the center and fixed subjects. Scenario 5: OLS POOLING.
#### Contents: 	
#### 
...
# Sampling proccess is controlled within centers and fixed amount of subjects! Scenario 5.
...
# Set WD
wd <- "/Volumes/2_TB_WD_Elements_10B8_Han/PhD/IMAGENDATA/Data/FreddieFreeloader/Data/OLS/Scenario5"
setwd(wd)
...
# Save object
save(MatrixOverlap,file=paste(wd,'/MatOverlapCenterScen5',sep=''))

# Load object
load(paste(wd,'/MatOverlapCenterScen5',sep=''))
